...
const NoChatSelected = () => {
  return (
    <div className="flex flex-col items-center justify-center h-full p-16 bg-white/50 w-full">
      <div className="max-w-md text-center space-y-6">
        ...
        {/* Welcome text */}
        <h2 className="text-2xl font-bold text-gray-800">Welcome to Convo!</h2>
