...
//                 isLoggingIn ? (
//                   <>
//                     <Loader className="w-5 h05 animate-spin" />Loading ...
//                   </>
//                 ) : (
//                   "Sign In"
//                 )
...
const Login = () => {
  ...
  return (
    <div className="min-h-screen grid grid-cols-1 lg:grid-cols-2 bg-white">
      ...
      <div className="flex flex-col justify-center items-center px-8 py-12">
        <div className="w-full max-w-md border border-gray-100 rounded-2xl shadow-lg p-10 bg-white">
          ...
          <div className="flex flex-col items-center text-center mb-8">
            ...
            <p className="text-gray-500 mt-2">Log in and start chatting with your friends</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            >
              {isLoggingIn ? <Loader className="w-5 h-5 animate-spin" /> : "Enter Chat"}
            </button>
          </form>
      ...
      {/* Right Side – Pattern */}
      <AuthImagePattern
        title="Step Into Your Chat World!"
        subtitle="Connect with friends, share messages, and enjoy real-time conversations."
      />
    </div>
  );
};
